...
app.MapControllerRoute(name: "recommendations-fragments", pattern: "inspire/fragment/recommendations/{id}", defaults: new { controller = "Recommendations", action = "RecommendationFragment" });
